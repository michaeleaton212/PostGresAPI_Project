...
namespace PostGresAPI.Migrations
{
    ...
    [Migration("20260105160652_AddPostRatingCommentSystem")]
    partial class AddPostRatingCommentSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostGresAPI.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PostGresAPI.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PostGresAPI.Models.PostRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PostId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_post_rating_post_user");

                    b.ToTable("PostRatings", (string)null);
                });

            modelBuilder.Entity("PostGresAPI.Models.PostVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PostId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_post_vote_post_user");
            ...
            modelBuilder.Entity("PostGresAPI.Models.Comment", b =>
                {
                    b.HasOne("PostGresAPI.Models.Post", "Post")
                        .WithMany("Comments")
